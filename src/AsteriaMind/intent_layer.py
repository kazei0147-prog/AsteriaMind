...
INTENT_PROFILES = {
    ...
    # ── F14: 复杂意图 (v3.9, U-03 方案 B) ──
    "HYPOTHESIS": {   # "假设推理" — 可能性链条 IS_A → CAN/HAS → 反向约束
        "IS_A": 2.0, "CAN": 2.5, "HAS": 1.5,
        "NOT_CAN": 1.0, "NOT_IS_A": 1.0, "EATS": 1.0, "LIVES_IN": 1.0,
    },
    "COUNTERFACTUAL": {  # "反事实推演" — 与事实相反的能力/属性最相关
        "NOT_CAN": 3.0, "NOT_IS_A": 3.0,
        "CAN": 2.0, "IS_A": 1.0, "HAS": 1.0,
    },
    "ASK": {       # 默认: "提问" — 均衡
    },
}
...
INTENT_TRIGGERS = {
    ...
    # ── F14: 复杂意图触发词 (v3.9) ──
    "HYPOTHESIS": ["如果","假设","假如","要是","设想"],
    "COUNTERFACTUAL": ["会怎样","会怎么样","要不是","如果不是","就好了","该多好"],
}
